...
public class ProductionOrderController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] CreateProductionOrderDto dto)
    {
        ...
        if (!User.HasClaim("permission", "CREATE:PRODUCTION_ORDERS")) return Forbid();
    ...
    {
        if (!User.HasClaim("permission", "EDIT:PRODUCTION_ORDERS")) return Forbid();
    ...
    {
        if (!User.HasClaim("permission", "DELETE:PRODUCTION_ORDERS")) return Forbid();
